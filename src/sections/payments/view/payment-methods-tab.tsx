  ...
  if (brandLower === "mastercard") {
    return (
      <svg viewBox="0 0 48 48" className="h-12 w-16">
        ...
        <path
          fill="#FF9800"
          d="M24 17.7c-2.1 1.6-3.4 4.1-3.4 6.8s1.3 5.2 3.4 6.8c2.1-1.6 3.4-4.1 3.4-6.8s-1.3-5.2-3.4-6.8z"
        />
      </svg>
    );
  }
  ...
  if (brandLower === "amex") {
    return (
      <svg viewBox="0 0 48 48" className="h-12 w-16">
        ...
        <path
          fill="#FFF"
          d="M22.9 21.5H20l-1.9 3.4-1.8-3.4h-2.9l3.3 5.5-3.3 5.5h2.9l1.8-3.4 1.9 3.4h2.9l-3.3-5.5 3.3-5.5zM32.5 21.5h-5.1v11h5.1v-2.2h-2.8v-2.3h2.8v-2.2h-2.8v-2.1h2.8v-2.2z"
        />
      </svg>
    );
  }
            ...
            {pm.isDefaultPaymentMethod ? (
              ...
              <>
                <Button
                  ...
                  className="px-3 py-1 h-auto text-xs font-medium rounded-full bg-black text-white hover:bg-black/80 border-0"
                >
                  {isSettingDefault ? (
  ...
  if (!clientSecret || clientSecret.trim() === "") {
    return (
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {[...Array(3)].map((_, i) => (
          <Card key={i} className="bg-muted/50 h-[200px] border-0">
            <CardContent className="p-5 h-full flex flex-col">
            ...
            <CardContent className="py-16">
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  <CardTitle className="text-lg">No Payment Methods</CardTitle>
